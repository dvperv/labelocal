        ...
        <div class="container has-text-centered">
          ...
          <b-message title="Коротко о главном..." type="is-warning" has-icon aria-close-label="Закрыть">
            ...
            <p>Текущая конфигурация: файлы с сервера обсерватории,
              ...
              <i>Если он отвалится в части хранения данных... Бэкапирования нет.</i></p>
            <p>***</p>
            <p>
              Аутентификация и вообще безопасность отсутствует, как класс. Это еще неделя - две работы...
              Можно рискнуть и в этом ключе, можно допилить - на ваше решение.
              <i>Риск: чьи-то пытливые руки могут испортить данные классификации.</i>
            </p>
